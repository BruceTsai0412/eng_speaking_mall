...
// class Recorder3 extends StatefulWidget {
//   @override
//   _VideoTestState createState() => _VideoTestState();
// }

// class _VideoTestState extends State<Recorder3> {
...
//                         onPressed: _playbackFilePath != null ? _playAudio : null,
//                       ),
//                       IconButton(
//                         color: Colors.black,
//                         icon: Icon(_isTranscribing ? Icons.stop : Icons.transcribe),
//                         onPressed: _isTranscribing ? _stopListening : _startListening,
//                       ),
//                       IconButton(
//                         color: Colors.black,
